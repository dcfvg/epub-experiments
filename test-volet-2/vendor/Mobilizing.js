(function (global, factory) {
  ...
  (factory((global.Mobilizing = global.Mobilizing || {}),global.THREE));
	...
	*/
	function getOrExec(object, key, fn) {
	    for (var _len = arguments.length, args = Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
	        args[_key - 3] = arguments[_key];
	    }

	    return object !== undefined && key in object ? object[key] : fn.apply(undefined, args);
	}
	...
	*/
	function getOrCreate(object, key, cls) {
	    for (var _len2 = arguments.length, args = Array(_len2 > 3 ? _len2 - 3 : 0), _key2 = 3; _key2 < _len2; _key2++) {
	        args[_key2 - 3] = arguments[_key2];
	    }

	    return object !== undefined && key in object ? object[key] : new (Function.prototype.bind.apply(cls, [null].concat(args)))();
	}
	...
	function singletonize(def) {
	    ...
	    return function () {
	        ...
	        if (instance === undefined) {
	            ...
	            instance = new (Function.prototype.bind.apply(def, [null].concat(args)))();
	        }
	        return instance;
	    };
	}
	        ...
	        value: function trigger(type) {
	            ...
	            if (this.listeners[type] instanceof Array) {
	                ...
	                listeners.forEach(function (listener) {
	                    listener.call.apply(listener, [_this._scope].concat(data));
	                });
	            }
	    ...
	    */
	    ...
	    createClass(Component, [{
	        ...
	        */
	        ...
	        key: 'chain',
	        value: function chain(component) {
	        ...
	        */
	        ...
	        key: 'getChainedComponents',
	        value: function getChainedComponents() {
	            return this._nexts;
	        }
	    }]);
	    return Component;
	    ...
	    */
	    function AudioSource(params) {
	        ...
	        if (_this.renderer.audioContext !== undefined) {
	            ...
	            _this.panner.distanceModel = 'exponential';
	            _this.panner.refDistance = 10;
	            _this.panner.maxDistance = 10000;
	            _this.panner.rolloffFactor = 1;
	            _this.panner.coneInnerAngle = 360;
	            _this.panner.coneOuterAngle = 0;
	            _this.panner.coneOuterGain = 0;
	        }
	        _this.is3D = false;
	        _this.loop = false;
	        return _this;
	    ...
	    */
	    ...
	    createClass(AudioSource, [{
	        ...
	        */
	        ...
	        key: "setMaxDistance",
	        value: function setMaxDistance(val) {
	...
	var Color$1 = function (_THREE$Color) {
	  ...
	  createClass(Color$$1, [{
	    ...
	    */
	    ...
	    key: "makeRGBAStringWithAlpha",
	    value: function makeRGBAStringWithAlpha(a) {
	...
	*/
	 ...
	 * @static
	 */
	Color$1.lightBlue = new Color$1(0.5, 0.5, 1);

	Color$1.mobilizing = new Color$1(60 / 255, 30 / 255, 1);
	Color$1.mobilizingDark = new Color$1(36 / 255, 18 / 255, 153 / 255);
	Color$1.mobilizingLight = new Color$1(208 / 255, 202 / 255, 247 / 255);
	Color$1.mobilizingAlternate = new Color$1(255 / 255, 158 / 255, 116 / 255);
	...
	*/
	...
	var _Math = function () {
	    ...
	    createClass(_Math, null, [{
	        ...
	        key: "lerp",
	        value: function lerp(value, dest, amount) {
	        ...
	        key: "pointIsInside",
	        value: function pointIsInside(x, y, points) {
	            var i = void 0,
	                j = points.length - 1;
	            var oddNodes = false;
	        ...
	        value: function intersectionPoint(line1, line2) {
	...
	*/
	...
	var Camera = function () {
	    ...
	    */
	    ...
	    function Camera(params) {
	        ...
	        var position = getOrDefault(params, "position", undefined);

	        if (this.type === "perspective") {
	            if (this.context) {
	                var canvasSize = this.context.getCanvasSize();
	                debug.log("camera canvasSize", canvasSize);
	                this._camera = new THREE.PerspectiveCamera(this.fov, canvasSize.width / canvasSize.height, this.near, this.far);
	            } else {
	            ...
	            if (this.context) {
	                var _canvasSize = this.context.getCanvasSize();
	                this._camera = new THREE.OrthographicCamera(_canvasSize.width / -2, _canvasSize.width / 2, _canvasSize.height / 2, _canvasSize.height / -2, this.near, this.far);
	            } else {
	                this._camera = new THREE.OrthographicCamera(window.innerWidth / -2, window.innerWidth / 2, window.innerHeight / 2, window.innerHeight / -2, this.near, this.far);
	            }
	    ...
	    createClass(Camera, [{
	        ...
	        key: 'setAutorender',
	        value: function setAutorender(b) {
	            this.autorender = b;
	        }
	        ...
	        */
	        ...
	        key: 'setAspect',
	        value: function setAspect(ratio) {
	        ...
	        key: 'setVerticalShift',
	        value: function setVerticalShift(ratio) {
	        ...
	        key: 'setHorizontalShift',
	        value: function setHorizontalShift(ratio) {
	        ...
	        */
	        ...
	        @param {Number} bottom
	        */
	        value: function setOrthoPlanes(left, right, top, bottom) {
	            if (this.type === "ortho") {
	        ...
	        */
	        value: function setFarPlane(far) {
	            if (this.type !== "cube") {
	        ...
	        */
	        value: function setNearPlane(near) {
	            if (this.type !== "cube") {
	        ...
	        */
	        value: function setPlanes(near, far) {
	            this._camera.far = far;
	            this._camera.near = near;
	            this.updateProjectionMatrix();
	        }
	        ...
	        */
	        ...
	        key: 'setToPixel',
	        value: function setToPixel() {
	            if (this.type === "perspective") {
	                var newPos;

	                if (this.context) {
	                    var canvasSize = this.context.getCanvasSize();
	                    newPos = new Vector3$1(canvasSize.width / 2, -canvasSize.height / 2, 1 / (2 * Math.tan(_Math.degToRad(this.fov / 2.0) / canvasSize.height)));
	                } else {
	                    newPos = new Vector3$1(window.innerWidth / 2, -window.innerHeight / 2, 1 / (2 * Math.tan(_Math.degToRad(this.fov / 2.0) / window.innerHeight)));
	                }
	        ...
	        key: 'perspectiveOffCenter',
	        value: function perspectiveOffCenter(left, right, bottom, top, near, far) {
	...
	var Light = function () {
	    ...
	    function Light(params) {
	        ...
	        this.light.color = getOrDefault(params, "color", Color$1.white);
	    ...
	    */
	    ...
	    createClass(Light, [{
	        ...
	        */
	        ...
	        value: function setTargetPosition(arg1, arg2, arg3) {
	            if (this.type === "spot") {
	        ...
	        */
	        ...
	        key: 'setPenumbra',
	        value: function setPenumbra(val) {
	        ...
	        key: 'setShadowSize',
	        value: function setShadowSize(width, height) {
	        ...
	        value: function setShadowDistance(near, far) {
	    ...
	    */
	    ...
	    createClass(Transform, [{
	        ...
	        */
	        ...
	        key: 'setLocalQuaternion',
	        value: function setLocalQuaternion(q) {

	            if (q instanceof Quaternion$1) {
	        ...
	        */
	        ...
	        key: 'getLocalQuaternion',
	        value: function getLocalQuaternion() {
	            var temp = new Quaternion$1(this.entity.quaternion.x, this.entity.quaternion.y, this.entity.quaternion.z, this.entity.quaternion.w);
	            return temp;
	        }
	    }, {
	        key: 'setLocalMatrix',
	        value: function setLocalMatrix(m) {

	            this.entity.matrixAutoUpdate = false;

	            var mat = new Matrix4$1().multiplyMatrices(this.entity.matrix, m);
	        ...
	        value: function setLocalEulerAngles(arg1, arg2, arg3) {
	        ...
	        value: function setLocalRotation() {
	        ...
	        */
	        ...
	        key: 'setLocalRotationX',
	        value: function setLocalRotationX(arg) {
	        ...
	        */
	        ...
	        key: 'setLocalRotationY',
	        value: function setLocalRotationY(arg) {
	            if (typeof arg === "number") {
	        ...
	        */
	        ...
	        key: 'setLocalRotationZ',
	        value: function setLocalRotationZ(arg) {
	            if (typeof arg === "number") {
	        ...
	        */
	        ...
	        key: 'getLocalRotationX',
	        value: function getLocalRotationX() {
	        ...
	        */
	        ...
	        key: 'getLocalRotationY',
	        value: function getLocalRotationY() {
	        ...
	        */
	        ...
	        key: 'getLocalRotationZ',
	        value: function getLocalRotationZ() {
	        ...
	        value: function setLocalPosition(arg1, arg2, arg3) {
	        ...
	        */
	        ...
	        value: function setLocalPositionX(arg) {
	            if (typeof arg === "number") {
	        ...
	        */
	        ...
	        value: function setLocalPositionY(arg) {
	            if (typeof arg === "number") {
	        ...
	        */
	        ...
	        key: 'setLocalPositionZ',
	        value: function setLocalPositionZ(arg) {
	            if (typeof arg === "number") {
	        ...
	        */
	        ...
	        value: function getLocalPosition() {
	            var tempVec = new Vector3$1(this.entity.position.x, this.entity.position.y, this.entity.position.z);
	            return tempVec;
	        }
	        ...
	        */
	        ...
	        value: function getLocalPositionX() {
	        ...
	        */
	        ...
	        value: function getLocalPositionY() {
	        ...
	        */
	        ...
	        key: 'getLocalPositionZ',
	        value: function getLocalPositionZ() {
	        ...
	        */
	        ...
	        key: 'setLocalScale',
	        value: function setLocalScale(arg1, arg2, arg3) {
	            if (arguments.length === 3) {
	        ...
	        */
	        ...
	        key: 'setLocalScaleX',
	        value: function setLocalScaleX(arg) {
	            if (typeof arg === "number") {
	        ...
	        */
	        ...
	        key: 'setLocalScaleY',
	        value: function setLocalScaleY(arg) {
	            if (typeof arg === "number") {
	        ...
	        */
	        ...
	        key: 'setLocalScaleZ',
	        value: function setLocalScaleZ(arg) {
	            if (typeof arg === "number") {
	        ...
	        */
	        ...
	        value: function getLocalScale() {
	            var temp = new Vector3$1(this.entity.scale.x, this.entity.scale.y, this.entity.scale.z);
	            return temp;
	        }
	        ...
	        */
	        ...
	        value: function getScreenCoordinates(context, camera) {
	        ...
	        */
	        ...
	        key: 'setRenderOrder',
	        value: function setRenderOrder(val) {
	    ...
	    */
	    ...
	    createClass(Mesh$$1, [{
	        ...
	        */
	        ...
	        key: 'constructPlane',
	        value: function constructPlane(params) {
	        ...
	        */
	        ...
	        key: 'constructQuad',
	        value: function constructQuad(params) {
	            var point1 = getOrDefault(params, "point1", new Vector2$1(-1, 1));
	            var point2 = getOrDefault(params, "point2", new Vector2$1(1, 1));
	        ...
	        */
	        ...
	        key: 'constructCube',
	        value: function constructCube(params) {
	        ...
	        */
	        ...
	        key: 'constructBox',
	        value: function constructBox(params) {
	        ...
	        */
	        ...
	        key: 'constructSphere',
	        value: function constructSphere(params) {
	        ...
	        */
	        ...
	        key: 'constructCircle',
	        value: function constructCircle(params) {
	        ...
	        */
	        ...
	        key: 'constructIcosahedron',
	        value: function constructIcosahedron(params) {
	            //radius detail
	            var radius = getOrDefault(params, "radius", 1);
	        ...
	        */
	        ...
	        key: 'constructOctahedron',
	        value: function constructOctahedron(params) {
	            var radius = getOrDefault(params, "radius", 1);
	            var detail = getOrDefault(params, "detail", 0);
	        ...
	        */
	        ...
	        key: 'constructText',
	        value: function constructText(params) {
	            //FIXME : il faut utiliser un loader pour charger le json de la typo produit par typeface.js
	            var text = getOrDefault(params, "text", "text");
	            var fontSize = getOrDefault(params, "fontSize", 1);
	            var height = getOrDefault(params, "height", 1);
	        ...
	        */
	        ...
	        value: function constructArc(params) {
	            ...
	            var radius = getOrDefault(params, "radius", 1);
	            var width = getOrDefault(params, "width", 0.2);
	            var segments = getOrDefault(params, "segments", 32);
	            ...
	            var uvScale = params.uvScale;
	            var center = getOrDefault(params, "center", Vector3$1.zero.clone());
	        ...
	        */
	        ...
	        key: 'generateFlatUVs',
	        value: function generateFlatUVs() {
	        ...
	        */
	        ...
	        key: 'createLine',
	        value: function createLine(start, end, color, texture, width, uvScale) {
	            var right = Vector3$1.zero;
	            var dir = Vector3$1.zero;
	            ...
	            right.crossVectors(dir, new Vector3$1(0, 0, 1)); //right vector
	            right.x *= width;
	            right.y *= width;
	            right.z *= width;

	            var p1 = new Vector3$1(start.x - right.x, start.y - right.y, start.z - right.z);
	            var p2 = new Vector3$1(start.x + right.x, start.y + right.y, start.z + right.z);
	            var p3 = new Vector3$1(end.x + right.x, end.y + right.y, end.z + right.z);
	            var p4 = new Vector3$1(end.x - right.x, end.y - right.y, end.z - right.z);
	        ...
	        */
	        ...
	        key: 'createCircle',
	        value: function createCircle(params) {
	        ...
	        */
	        ...
	        key: 'createArc',
	        value: function createArc(params) {
	            var center = getOrDefault(params, "center", new Vector3$1(0, 0, 0));
	            var radius = getOrDefault(params, "radius", 1);
	            var segments = getOrDefault(params, "segments", 32);
	            var startAngle = getOrDefault(params, "startAngle", 0);
	            ...
	            for (a = starta; a <= enda; a += interval) {
	                innerpoints.push(new Vector3$1(Math.cos(a) * (radius - width / 2), Math.sin(a) * (radius - width / 2), 0));
	                outerpoints.push(new Vector3$1(Math.cos(a) * (radius + width / 2), Math.sin(a) * (radius + width / 2), 0));
	            }

	            //on termine l'arc si on n'était pas sur un multiple
	            if (a !== enda) {
	                innerpoints.push(new Vector3$1(Math.cos(endAngle) * (radius - width / 2), Math.sin(endAngle) * (radius - width / 2), 0));
	                outerpoints.push(new Vector3$1(Math.cos(endAngle) * (radius + width / 2), Math.sin(endAngle) * (radius + width / 2), 0));
	            }

	            for (var k = 0; k < innerpoints.length - 1; ++k) {
	                var p1 = outerpoints[k];
	                var p2 = innerpoints[k];
	                var p3 = innerpoints[(k + 1) % innerpoints.length];
	                var p4 = outerpoints[(k + 1) % innerpoints.length];

	                var uv1 = new Vector2$1(0, (k + 0) * uvScale / (innerpoints.length - 1));
	                var uv2 = new Vector2$1(1, (k + 0) * uvScale / (innerpoints.length - 1));
	                var uv3 = new Vector2$1(1, (k + 1) * uvScale / (innerpoints.length - 1));
	                var uv4 = new Vector2$1(0, (k + 1) * uvScale / (innerpoints.length - 1));
	        ...
	        */
	        ...
	        key: 'createDisc',
	        value: function createDisc(center, radius, segments, color, texture) {
	        ...
	        */
	        ...
	        key: 'createDiscSector',
	        value: function createDiscSector(params) {
	            ...
	            for (a = starta; a <= enda; a += interval) {
	                points.push(new Vector3$1(Math.cos(a) * radius, Math.sin(a) * radius, 0));
	            }
	            //on termine si on n'était pas sur un multiple
	            if (a !== enda) {
	                points.push(new Vector3$1(Math.cos(endAngle) * radius, Math.sin(endAngle) * radius, 0));
	            }

	            var p1 = new Vector3$1(0, 0, 0); //local center
	            ...
	            for (var k = 0; k < points.length - 1; ++k) {
	                ...
	                var uv1 = new Vector2$1(0, 0);
	                var uv2 = new Vector2$1(1, 0);
	                var uv3 = new Vector2$1(1, 1);
	        ...
	        */
	        ...
	        key: 'pushUV',
	        value: function pushUV(uv1, uv2, uv3) {
	        ...
	        */
	        ...
	        key: 'pushNormal',
	        value: function pushNormal(n1, n2, n3) {
	        ...
	        */
	        ...
	        key: 'pushQuad',
	        value: function pushQuad(v1, v2, v3, v4, uv1, uv2, uv3, uv4) {
	            var i = this._geometry.vertices.length;
	        ...
	        */
	        ...
	        key: 'setUVs',
	        value: function setUVs(index, uvs) {
	        ...
	        */
	        ...
	        value: function setCenter(x, y, z) {
	            this._geometry.applyMatrix(new Matrix4$1().makeTranslation(x, y, z));
	        }
	        ...
	        */
	        ...
	        key: 'setScale',
	        value: function setScale(arg1, arg2, arg3) {
	            if (arguments.length === 3) {
	                this._geometry.applyMatrix(new Matrix4$1().makeScale(arg1, arg2, arg3));
	            } else if (arguments.length === 2) {
	                if (typeof arg1 === "number" && typeof arg2 === "number") {
	                    this._geometry.applyMatrix(new Matrix4$1().makeScale(arg1, arg2, 1));
	                }
	            } else if (arguments.length === 1) {
	                if (arg1 instanceof Vector3$1) {
	                    this._geometry.applyMatrix(new Matrix4$1().makeScale(arg1.x, arg1.y, arg1.z));
	                } else if (arg1 instanceof Vector2$1) {
	                    this._geometry.applyMatrix(new Matrix4$1().makeScale(arg1.x, arg1.y, 1));
	                } else if (typeof arg1 === "number") {
	                    this._geometry.applyMatrix(new Matrix4$1().makeScale(arg1, arg1, arg1));
	                }
	            }
	        }
	        ...
	        */
	        ...
	        key: 'setRotationX',
	        value: function setRotationX(arg1) {
	            this._geometry.applyMatrix(new Matrix4$1().makeRotationX(_Math.degToRad(arg1)));
	        }
	        ...
	        */
	        ...
	        key: 'setRotationY',
	        value: function setRotationY(arg1) {
	            this._geometry.applyMatrix(new Matrix4$1().makeRotationY(_Math.degToRad(arg1)));
	        }
	        ...
	        */
	        ...
	        key: 'setRotationZ',
	        value: function setRotationZ(arg1) {
	            this._geometry.applyMatrix(new Matrix4$1().makeRotationZ(_Math.degToRad(arg1)));
	        }
	        ...
	        */
	        ...
	        value: function setMaterial(material) {
	            ...
	            this.mesh = tempMesh;
	            this.transform = new Transform(this);
	            this.transform.setLocalScale(tempTransform.getLocalScale().x, tempTransform.getLocalScale().y, tempTransform.getLocalScale().z);

	            this.transform.setLocalPosition(tempTransform.getLocalPosition().x, tempTransform.getLocalPosition().y, tempTransform.getLocalPosition().z);

	            this.transform.setLocalRotation(tempTransform.getLocalRotation().x, tempTransform.getLocalRotation().y, tempTransform.getLocalRotation().z);
	        }
	        ...
	        */
	        ...
	        key: 'attachMaterial',
	        value: function attachMaterial(material) {
	            if (material === undefined) {
	                this.material = new Material({ type: "default" });
	            } else if (material instanceof Material) {
	                this.material = material;
	        ...
	        value: function generateStrokeShape(mesh, inflateValue) {
	            ...
	            var tempOutterGeom = mesh._geometry.clone();
	            ...
	            var rot = Mesh$$1.geometryIsCW(innerGeom) ? "ccw" : "cw";

	            for (var i = 0; i < tempOutterGeom.vertices.length; i++) {
	                // get this point (pt1), the point before it
	                // (pt0) and the point that follows it (pt2)
	                var pt0 = tempOutterGeom.vertices[i > 0 ? i - 1 : tempOutterGeom.vertices.length - 1];
	                var pt1 = tempOutterGeom.vertices[i];
	                var pt2 = tempOutterGeom.vertices[i < tempOutterGeom.vertices.length - 1 ? i + 1 : 0];
	                ...
	                var d01 = v01.multiplyScalar(inflateValue).clone();
	                var d12 = v12.multiplyScalar(inflateValue).clone();
	                //console.log(d01, d12);
	                ...
	                var newPoint = _Math.intersectionPoint([ptx0, ptx10], [ptx12, ptx2]);
	            ...
	            for (var _i = innerGeom.vertices.length - 1; _i > 0; _i--) {
	                outterPath.lineTo(outterGeom.vertices[_i].x, outterGeom.vertices[_i].y);
	                innerPath.lineTo(innerGeom.vertices[_i].x, innerGeom.vertices[_i].y);
	            }
	        ...
	        */
	        ...
	        key: 'geometryIsCW',
	        value: function geometryIsCW(geometry) {
	            var vertices = geometry.vertices;

	            for (var i = 0; i < vertices.length; i++) {
	                var v1 = new Vector2$1(vertices[i + 1].x - vertices[i].x, vertices[i + 1].y - vertices[i].y);

	                var v2 = new Vector2$1(vertices[i + 2].x - vertices[i + 1].x, vertices[i + 2].y - vertices[i + 1].y);
	        ...
	        */
	        ...
	        key: 'CreateBox',
	        value: function CreateBox(sizeX, sizeY, sizeZ, segments, material) {
	            var obj = new Mesh$$1({ primitive: "box",
	                width: sizeX,
	                height: sizeY,
	                depth: sizeZ,
	                segments: segments,
	        ...
	        key: 'CreateCircle',
	        value: function CreateCircle(radius, segments, material) {
	            var obj = new Mesh$$1({ primitive: "circle",
	                segments: segments,
	                material: material
	            });
	            return obj;
	    ...
	    */
	    ...
	    createClass(Csg, null, [{
	        ...
	        value: function substract(mobMesh1, mobMesh2) {
	            ...
	            var newMobMesh = new Mesh$1(undefined, undefined, BSPGeom);
	        ...
	        */
	        ...
	        key: 'union',
	        value: function union(mobMesh1, mobMesh2) {
	        ...
	        */
	        ...
	        key: 'intersect',
	        value: function intersect(mobMesh1, mobMesh2) {
	...
	var Device = function () {
	    ...
	    createClass(Device, null, [{
	        ...
	        */
	        ...
	        key: "parseBrowserData",
	        value: function parseBrowserData() {
	...
	*/
	...
	var BatteryStatus = function (_Component) {
	    ...
	    createClass(BatteryStatus, [{
	        ...
	        value: function off() {
	            ...
	            if (this._manager) {
	                this._manager.removeEventListener("chargingchange", function (event) {
	                    return _this3.onChargingChange(event);
	                });
	                this._manager.removeEventListener("chargingtimechange", function (event) {
	                    return _this3.onChargingTimeChange(event);
	                });
	                this._manager.removeEventListener("levelchange", function (event) {
	                    return _this3.onLevelChange(event);
	                });
	                this._manager.removeEventListener("dischargingtimechange", function (event) {
	                    return _this3.onDischargingTimeChange(event);
	                });
	        ...
	        */
	        ...
	        key: 'onBatteryManager',
	        value: function onBatteryManager(manager) {
	            var _this4 = this;
	            ...
	            this._manager.addEventListener("chargingchange", function (event) {
	                return _this4.onChargingChange(event);
	            });
	            this._manager.addEventListener("chargingtimechange", function (event) {
	                return _this4.onChargingTimeChange(event);
	            });
	            this._manager.addEventListener("levelchange", function (event) {
	                return _this4.onLevelChange(event);
	            });
	            this._manager.addEventListener("dischargingtimechange", function (event) {
	                return _this4.onDischargingTimeChange(event);
	            });
	        }
	        ...
	        */
	        ...
	        key: 'onChargingChange',
	        value: function onChargingChange(event) {
	        ...
	        */
	        ...
	        key: 'onChargingTimeChange',
	        value: function onChargingTimeChange(event) {
	        ...
	        */
	        ...
	        key: 'onDischargingTimeChange',
	        value: function onDischargingTimeChange(event) {
	        ...
	        */
	        ...
	        key: 'onLevelChange',
	        value: function onLevelChange(event) {
	        ...
	        */
	        ...
	        key: 'getChargingTime',
	        value: function getChargingTime() {
	            if (!this._manager) {
	                debug.warn('The battery component needs to be active to get battery information');
	                return null;
	            }
	        ...
	        */
	        ...
	        key: 'getDischargingTime',
	        value: function getDischargingTime() {
	            if (!this._manager) {
	                debug.warn('The battery component needs to be active to get battery information');
	                return null;
	            }
	    ...
	    */
	    ...
	    createClass(Keyboard, [{
	        ...
	        value: function on() {
	            ...
	            this._target.addEventListener("keypress", function (event) {
	                return _this2.onKeyPress(event);
	            });
	            this._target.addEventListener("keyup", function (event) {
	        ...
	        value: function off() {
	            ...
	            this._target.removeEventListener("keypress", function (event) {
	                return _this3.onKeyPress(event);
	            });
	            this._target.removeEventListener("keyup", function (event) {
	                return _this3.onKeyUp(event);
	            });
	        }
	    }, {
	        key: 'setup',
	    ...
	    createClass(Mouse, [{
	        ...
	        */
	        ...
	        value: function on() {
	            ...
	            this._target.addEventListener("mousemove", function (event) {
	                return _this2.onMouseMove(event);
	            });
	            this._target.addEventListener("mouseover", function (event) {
	                return _this2.onMouseOver(event);
	            });
	            this._target.addEventListener("mouseout", function (event) {
	                return _this2.onMouseOut(event);
	            });
	            this._target.addEventListener("mousedown", function (event) {
	                return _this2.onMouseDown(event);
	            });
	            this._target.addEventListener("mouseup", function (event) {
	                return _this2.onMouseUp(event);
	            });
	            this._target.addEventListener("click", function (event) {
	                return _this2.onClick(event);
	            });
	            this._target.addEventListener("dblclick", function (event) {
	                return _this2.onDblClick(event);
	            });
	            this._target.addEventListener("wheel", function (event) {
	        ...
	        */
	        ...
	        value: function off() {
	            ...
	            this._target.removeEventListener("mousemove", function (event) {
	                return _this3.onMouseMove(event);
	            });
	            this._target.removeEventListener("mouseover", function (event) {
	                return _this3.onMouseOver(event);
	            });
	            this._target.removeEventListener("mouseout", function (event) {
	                return _this3.onMouseOut(event);
	            });
	            this._target.removeEventListener("mousedown", function (event) {
	                return _this3.onMouseDown(event);
	            });
	            this._target.removeEventListener("mouseup", function (event) {
	                return _this3.onMouseUp(event);
	            });
	            this._target.removeEventListener("click", function (event) {
	                return _this3.onClick(event);
	            });
	            this._target.removeEventListener("dblclick", function (event) {
	                return _this3.onDblClick(event);
	            });
	            this._target.removeEventListener("wheel", function (event) {
	                return _this3.onWheel(event);
	            });
	        }
	    }, {
	        key: 'preUpdate',
	        ...
	        */
	        ...
	        key: 'isWheelSupported',
	        value: function isWheelSupported() {
	        ...
	        */
	        ...
	        key: 'isWheelActivated',
	        value: function isWheelActivated() {
	    ...
	    */
	    ...
	    createClass(TouchObject, [{
	        ...
	        */
	        ...
	        key: 'setPX',
	        value: function setPX() {
	            this.pX = this.x;
	        }
	    }, {
	        key: 'setPY',
	        value: function setPY() {
	            this.pY = this.y;
	        }
	    }]);
	    return TouchObject;
	    ...
	    */
	    ...
	    createClass(Touch, [{
	        ...
	        value: function on() {
	            ...
	            this._target.addEventListener("touchcancel", function (event) {
	                return _this2.onTouchEnd(event);
	            });
	            this._target.addEventListener("touchleave", function (event) {
	                return _this2.onTouchEnd(event);
	            });
	        ...
	        value: function off() {
	            ...
	            this._target.removeEventListener("touchend", function (event) {
	                return _this3.onTouchEnd(event);
	            });
	            this._target.removeEventListener("touchcancel", function (event) {
	                return _this3.onTouchEnd(event);
	            });
	            this._target.removeEventListener("touchleave", function (event) {
	                return _this3.onTouchEnd(event);
	            });

	            this._target.removeEventListener("touchmove", function (event) {
	        ...
	        */
	        ...
	        value: function getPinch() {
	            ...
	            if (this.count >= 2) {
	                ...
	                this.pinch = _Math.dist(this.pinchTouches[0].x, this.pinchTouches[0].y, this.pinchTouches[1].x, this.pinchTouches[1].y) - this.pinchStart;
	    ...
	    */
	    ...
	    createClass(Motion, [{
	        ...
	        value: function setup() {
	            ...
	            this.rotationRate = new Vector3$1();
	            this.acc = new Vector3$1();
	            this.userAcc = new Vector3$1();
	        ...
	        */
	        ...
	        key: 'getGravityVector',
	        value: function getGravityVector() {
	        ...
	        */
	        ...
	        key: 'getSmoothedAcc',
	        value: function getSmoothedAcc(factor) {
	    ...
	    createClass(Orientation, [{
	        ...
	        value: function on() {
	            ...
	            window.addEventListener("compassneedscalibration", function (event) {
	                return _this2.onCompassCalibration(event);
	            });
	        }
	    }, {
	        key: 'off',
	        value: function off() {
	            ...
	            window.removeEventListener("compassneedscalibration", function (event) {
	                return _this3.onCompassCalibration(event);
	            });
	        }
	        ...
	        */
	        ...
	        value: function getDeviceOrientation() {
	            return this.compass;
	        }
	        ...
	        */
	        ...
	        value: function createGyroQuaternion(alpha, beta, gamma, screenOrientation) {

	            if (alpha !== 0 && beta !== 0 && gamma !== 0) {

	                var finalQuaternion = new Quaternion$1();
	                var deviceEuler = new Euler$1();
	                var screenTransform = new Quaternion$1();
	                var worldTransform = new Quaternion$1(-Math.sqrt(0.5), 0, 0, Math.sqrt(0.5)); // - PI/2 around the x-axis
	        ...
	        */
	        ...
	        key: 'onCompassCalibration',
	        value: function onCompassCalibration(event) {
	...
	var GPS = function (_Component) {
	    ...
	    function GPS(params) {
	        ...
	        */
	        _this._GPSAvailable = navigator !== undefined && "geolocation" in navigator;
	        return _this;
	    }
	    ...
	    */
	    ...
	    createClass(GPS, [{
	        ...
	        */
	        ...
	        value: function on() {
	            ...
	            if (this._GPSAvailable) {
	                ...
	                this._watchID = navigator.geolocation.watchPosition(function (event) {
	                    return _this2.updateLocationCallBack(event);
	                }, function (event) {
	                    return _this2.updateLocationErrorCallBack(event);
	                }, positionOptions);
	            } else {
	        ...
	        */
	        ...
	        key: 'setEnableHighAccuracy',
	        value: function setEnableHighAccuracy(val) {
	        ...
	        */
	        ...
	        key: 'setMaximumAge',
	        value: function setMaximumAge(val) {
	        ...
	        */
	        ...
	        key: 'updateLocationCallBack',
	        value: function updateLocationCallBack(position) {
	            //debug.log(position);
	        ...
	        */
	        ...
	        key: 'updateLocationErrorCallBack',
	        value: function updateLocationErrorCallBack(error) {
	            if (error.code === 1) {
	...
	var _STATICS$1 = {};
	_STATICS$1.zoom = 1;
	_STATICS$1.worldSize = 512 * Math.pow(2, _STATICS$1.zoom);
	...
	*/
	...
	var GPSUtils = function () {
	    ...
	    createClass(GPSUtils, null, [{
	        ...
	        */
	        value: function getPixelsCoordsFromOSMLngLat(longitute, latitude, zoom) {
	            if (zoom) {
	                _STATICS$1.zoom = zoom;
	                _STATICS$1.worldSize = 512 * Math.pow(2, _STATICS$1.zoom);
	            }
	        ...
	        */
	        ...
	        key: 'getCoordinateInMap',
	        value: function getCoordinateInMap(longitute, latitude, mapCoord, mapWidth, mapHeight, zoom) {
	            if (zoom) {
	                _STATICS$1.zoom = zoom;
	            }
	            //construct local variable to simplify expressions writing
	            var leftLong = mapCoord[0];
	            var bottomLat = mapCoord[1];

	            var rightLong = mapCoord[2];
	            var topLat = mapCoord[3];

	            //construct the corners pixel coordinates
	            var topRight = GPSUtils.getPixelsCoordsFromOSMLngLat(rightLong, topLat);
	            ...
	            var coords = { x: _Math.map(absCoord.x, topRight.x, topLeft.x, mapWidth / 2, -mapHeight / 2),
	        ...
	        key: 'lngX',
	        value: function lngX(lng) {
	            return (180 + lng) * _STATICS$1.worldSize / 360;
	        }
	        /**
	        ...
	        key: 'latY',
	        value: function latY(lat) {
	            var y = 180 / Math.PI * Math.log(Math.tan(Math.PI / 4 + lat * Math.PI / 360));
	            return (180 - y) * _STATICS$1.worldSize / 360;
	        }
	    }, {
	        key: 'xLng',
	        value: function xLng(x) {
	            return x * 360 / _STATICS$1.worldSize - 180;
	        }
	    }, {
	        key: 'yLat',
	        value: function yLat(y) {
	            var y2 = 180 - y * 360 / _STATICS$1.worldSize;
	        ...
	        */
	        ...
	        key: 'getPolarFromLngLat',
	        value: function getPolarFromLngLat(longitude, latitude, radius) {
	            var lng = _Math.degToRad(longitude + 180);
	            var lat = _Math.degToRad(90 - latitude);

	            var x = -(radius * Math.cos(lng) * Math.sin(lat));
	            var y = radius * Math.cos(lat);
	            var z = radius * Math.sin(lat) * Math.sin(lng);
	...
	var MeshFX = function () {
	    ...
	    createClass(MeshFX, null, [{
	        ...
	        */
	        value: function Noise(mesh, amount) {
	            var vertices = mesh.getVertices();
	            for (var i = 0; i < vertices.length; ++i) {
	                var noise = new Vector3$1(Math.random() - 0.5, Math.random() - 0.5, Math.random() - 0.5);
	                vertices[i] = new Vector3$1(vertices[i].x + noise.x * amount, vertices[i].y + noise.y * amount, vertices[i].z + noise.z * amount);
	            }
	        ...
	        */
	        ...
	        key: 'Offset',
	        value: function Offset(mesh, offset) {
	            var vertices = mesh.getVertices();
	            for (var i = 0; i < vertices.length; ++i) {
	                vertices[i] = new Vector3$1(vertices[i].x + offset.x, vertices[i].y + offset.y, vertices[i].z + offset.z);
	            }
	            mesh.setVertices(vertices);
	        }
	        ...
	        */
	        ...
	        key: 'Scale',
	        value: function Scale(mesh, scale) {
	            var vertices = mesh.getVertices();
	            for (var i = 0; i < vertices.length; ++i) {
	                vertices[i] = new Vector3$1(vertices[i].x * scale.x, vertices[i].y * scale.y, vertices[i].z * scale.z);
	            }
	            mesh.setVertices(vertices);
	        }
	    }]);
	...
	var Midi = function (_Component) {
	    ...
	    function Midi(params) {
	        ...
	        //callbacks
	        _this.onMidiIn = params.onMidiIn;
	        debug.log("params.onMidiIn=" + params.onMidiIn);
	        debug.log("this.onMidiIn=" + _this.onMidiIn);
	        if (navigator.requestMIDIAccess) {
	            navigator.requestMIDIAccess().then(_this.onMIDIInit.bind(_this), _this.onMIDIReject.bind(_this));
	        } else {
	        ...
	        */
	        ...
	        value: function onMIDIMessage(event) {
	            ...
	            if (this.onMidiIn !== undefined) {
	                ...
	                var channel = event.data[0] - message;
	...
	*/
	...
	var Ajax = function () {
	    ...
	    */
	    function Ajax(params) {
	        ...
	        var data = getOrDefault(params, "data", null);
	        var headers = getOrDefault(params, "headers", null);
	        this.async = getOrDefault(params, "async", true);
	        var autoSend = getOrDefault(params, "autoSend", true);
	        var withCredentials = getOrDefault(params, "withCredentials", null);
	        var timeout = getOrDefault(params, "timeout", null);
	        var responseType = getOrDefault(params, "responseType", "text");
	        var onReadyStateChange = getOrDefault(params, "onReadyStateChange", null);
	        var onStart = getOrDefault(params, "onStart", null);
	        var onProgress = getOrDefault(params, "onProgress", null);
	        var onLoad = getOrDefault(params, "onLoad", null);
	        var onSuccess = getOrDefault(params, "onSuccess", null);
	        ...
	        if (onStart) {
	            this.events.on(EVT_START$1, onStart);
	        }
	        if (onProgress) {
	            this.events.on(EVT_PROGRESS, onProgress);
	        }
	        if (onLoad) {
	            this.events.on(EVT_LOAD$1, onLoad);
	        }
	        if (onSuccess) {
	            this.events.on(EVT_SUCCESS, onSuccess);
	        }
	        if (onError) {
	            this.events.on(EVT_ERROR$1, onError);
	        }
	        ...
	        value: function onReadyStateChange() {
	            ...
	            switch (this.getReadyState()) {
	                case XMLHttpRequest.OPENED:
	                    this.events.trigger(EVT_START$1, this);
	                    break;
	...
	var OBJ = function () {
	    ...
	    createClass(OBJ, null, [{
	         ...
	         */
	        value: function load(loader, params) {
	        ...
	        key: 'attachTexture',
	        value: function attachTexture(loader, model, texture) {
	        ...
	        key: 'parseMTL',
	        value: function parseMTL(loader, model, data) {
	        ...
	        key: 'parseOBJ',
	        value: function parseOBJ(loader, data) {
	...
	*/
	...
	var Loader = function () {
	    ...
	    */
	    function Loader(params) {
	        ...
	        var onLoad = getOrDefault(params, "onLoad", null);
	        var onError = getOrDefault(params, "onError", null);
	        var onComplete = getOrDefault(params, "onComplete", null);
	    ...
	    createClass(Loader, [{
	        ...
	        */
	        value: function load(params) {
	            ...
	            var onLoad = getOrDefault(params, "onLoad", null);
	            var onError = getOrDefault(params, "onError", null);
	            var responseType = getOrDefault(params, "responseType", "");
	            var processData = getOrDefault(params, "processData", function (ajax) {
	            ...
	            ajax.events.on("success", function (ajax) {
	                ...
	                _this.events.trigger(EVT_LOAD, request);
	            ...
	            ajax.events.on("error", function (ajax) {
	                ...
	                _this.events.trigger(EVT_ERROR, request);
	        ...
	        */
	        ...
	        key: 'loadText',
	        value: function loadText(params) {
	        ...
	        */
	        ...
	        key: 'loadJSON',
	        value: function loadJSON(params) {
	            return this.load(Object.assign({}, params, {
	                responseType: "json"
	            }));
	        }
	        ...
	        */
	        ...
	        key: 'loadImage',
	        value: function loadImage(params) {
	            var _this2 = this;
	            ...
	            img.addEventListener("load", function () {
	                ...
	                _this2.events.trigger(EVT_LOAD, request);
	            ...
	            img.addEventListener("error", function () {
	                var error = "Error loading the image " + url;

	                request.setError(error);
	                request.events.trigger(EVT_REQUEST_ERROR, error);

	                _this2.events.trigger(EVT_ERROR, request);
	        ...
	        */
	        ...
	        key: 'loadVideo',
	        value: function loadVideo(params) {
	            var _this3 = this;
	            ...
	            video.addEventListener("canplay", function () {
	                ...
	                _this3.events.trigger(EVT_LOAD, request);
	            ...
	            video.addEventListener("error", function () {
	                var error = "Error loading the video " + url + " " + video.error.code;
	                ...
	                _this3.events.trigger(EVT_ERROR, request);
	        ...
	        */
	        ...
	        key: 'loadArrayBuffer',
	        value: function loadArrayBuffer(params) {
	            return this.load(Object.assign({}, params, {
	        ...
	        */
	        ...
	        key: 'loadBlob',
	        value: function loadBlob(params) {
	            return this.load(Object.assign({}, params, {
	                responseType: "blob"
	            }));
	        }
	        ...
	        */
	        ...
	        key: 'load',
	        value: function load(url, callback, responseType, processData) {
	        ...
	        */
	        ...
	        key: 'loadArrayBuffer',
	        value: function loadArrayBuffer(url, callback) {
	        ...
	        */
	        ...
	        key: 'loadBlob',
	        value: function loadBlob(url, callback) {
	    ...
	    */
	    ...
	    createClass(Cache, [{
	        ...
	        */
	        ...
	        key: 'addValue',
	        value: function addValue(key, file) {
	            if (this.enabled === false) {
	                return;
	            }
	        ...
	        */
	        ...
	        value: function addCallback(key, callback) {
	            var temp = { key: key, callback: callback };
	...
	var PointerObject = function () {
	    ...
	    */
	    function PointerObject(params) {
	        ...
	        var state = getOrDefault(params, "state", false);
	        var type = getOrDefault(params, "type", undefined);
	    ...
	    */
	    ...
	    createClass(Pointer, [{
	        ...
	        value: function postUpdate() {
	            ...
	            try {
	                for (var _iterator = this.pointers.keys()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var pointerKey = _step.value;

	                    var pointer = this.pointers.get(pointerKey);
	        ...
	        */
	        ...
	        value: function add(component) {
	            ...
	            if (component instanceof Touch) {
	                var touchComponent = component; //just to understand better
	                //console.log("will add Touch comp", touchComponent);

	                //register a new Pointer at touch creation
	                touchComponent.events.on("touchstart", function (touch) {
	                    ...
	                    _this2.pointers.set(touch.id, pointer);

	                    _this2.events.trigger(EVT_ON, { pointer: pointer, x: pointer.getX(), y: pointer.getY() });

	                    _this2.lastActivePointer.setState(true);
	                    _this2.lastActivePointer.setX(touch.x);
	                    _this2.lastActivePointer.setY(touch.y);
	                    //console.log("touchstart", pointer, this.pointers);
	                });

	                //updates a Pointer at touch mouved
	                touchComponent.events.on("touchmoved", function (touch) {

	                    var pointer = _this2.pointers.get(touch.id);
	                    pointer.setState(true);
	                    pointer.setX(touch.x);
	                    pointer.setY(touch.y);
	                    pointer.setDeltaX(touch.xDelta);
	                    pointer.setDeltaY(touch.yDelta);
	                    _this2.events.trigger(EVT_MOVED, { pointer: pointer, x: pointer.getX(), y: pointer.getY() });

	                    _this2.lastActivePointer.setState(true);
	                    _this2.lastActivePointer.setX(touch.x);
	                    _this2.lastActivePointer.setY(touch.y);
	                    _this2.lastActivePointer.setDeltaX(touch.xDelta);
	                    _this2.lastActivePointer.setDeltaY(touch.yDelta);
	                    //console.log("touchmoved", pointer);
	                });

	                //updates a Pointer at touch mouved
	                touchComponent.events.on("touchend", function (touch) {
	                    ...
	                    _this2.lastActivePointer.setState(false);
	                    _this2.lastActivePointer.setX(touch.x);
	                    _this2.lastActivePointer.setY(touch.y);
	                ...
	                mouseComponent.events.on("mousemove", function (coords) {
	                    var pointer = _this2.pointers.get(component.getID());
	                    ...
	                    _this2.lastActivePointer.setState(true);
	                    _this2.lastActivePointer.setX(pointer.getX());
	                    _this2.lastActivePointer.setY(pointer.getY());
	        ...
	        */
	        ...
	        value: function getState() {
	            ...
	            try {
	                for (var _iterator2 = this.pointers.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	        ...
	        */
	        ...
	        value: function getX(index) {
	            ...
	            try {
	                for (var _iterator3 = this.pointers.values()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	        ...
	        */
	        ...
	        value: function getY(index) {
	            ...
	            try {
	                for (var _iterator4 = this.pointers.values()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	        ...
	        */
	        ...
	        value: function getDeltaX(index) {
	            ...
	            try {
	                for (var _iterator5 = this.pointers.values()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	        ...
	        */
	        ...
	        value: function getDeltaY(index) {
	            ...
	            try {
	                for (var _iterator6 = this.pointers.values()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	        ...
	        value: function open(url) {
	            ...
	            if (typeof io === "undefined") {
	                ...
	                this.socket.on('error', function (error) {
	                    _this.events.trigger(EVT_ERROR$2, error);
	                });
	            }
	        }
	...
	var PhysicsEngine = function (_Component) {
	    ...
	    function PhysicsEngine(params) {
	        ...
	        _this.joints = [];
	        _this.bodies = [];
	        _this.iterations = getOrDefault(params, "iterations", 5);

	        _this.G = 6.6742 * Math.pow(10, -11); //constante gravitationnelle
	        _this.ke = 8.99 * Math.pow(10, 9); //coulomb's constant
	        _this.relaxationCoeff = 1;
	        return _this;
	    }
	    ...
	    createClass(PhysicsEngine, [{
	            ...
	            if (this._active) {
	                ...
	                for (var _j = 0; _j < this.joints.length; ++_j) {
	                    ...
	                    if (joint.type === "spring") {
	                        ...
	                        //damping force
	                        var sx = joint.body2.velocity.x - joint.body1.velocity.x;
	                        var sy = joint.body2.velocity.y - joint.body1.velocity.y;
	                        var sz = joint.body2.velocity.z - joint.body1.velocity.z;
	                        ...
	                        var mass = joint.body1.mass + joint.body2.mass;
	                ...
	                for (i = 0; i < this.bodies.length; ++i) {
	                    ...
	                    if (body.speed !== undefined) {
	                        body.velocity = new Vector3$1(body.speed.x, body.speed.y, body.speed.z);
	                        body.speed = undefined;
	                    } else {
	                        body.velocity = new Vector3$1(body.position.x - body.previousposition.x, body.position.y - body.previousposition.y, body.position.z - body.previousposition.z);
	                    ...
	                    body.previousposition = new Vector3$1(body.position.x, body.position.y, body.position.z);
	                ...
	                for (var _i2 = 0; _i2 < this.iterations; ++_i2) {
	                    for (var _j2 = 0; _j2 < this.joints.length; ++_j2) {
	                        ...
	                        if (joint.type === "stick" || joint.type === "string") {
	                            ...
	                            var err = (distance - joint.distance) / distance * 1;
	                            //console.log("err=" + err);
	                            ...
	                            joint.body1.position = new Vector3$1(joint.position.x, joint.position.y, joint.position.z);
	                            joint.body1.velocity = new Vector3$1(0, 0, 0);
	                        }
	                    }
	                }
	        ...
	        */
	        ...
	        key: 'addBody',
	        value: function addBody(position, mass, object) {
	            var body = {};
	            body.position = new Vector3$1(position.x, position.y, position.z);
	            //console.log("body position : ", body.position);
	            body.previousposition = new Vector3$1(position.x, position.y, position.z);
	            body.mass = mass;
	            body.object = object;
	            body.velocity = new Vector3$1(0, 0, 0);
	        ...
	        */
	        ...
	        key: 'addFixedJoint',
	        value: function addFixedJoint(body, position) {
	            var joint = {};
	            joint.body1 = body;
	            joint.body1.fixed = true;
	            joint.type = "fixed";
	            joint.position = new Vector3$1(position.x, position.y, position.z);
	            joint.enabled = true;
	        ...
	        */
	        ...
	        key: 'addStickJoint',
	        value: function addStickJoint(body1, body2, distance) {
	            var joint = {};
	            joint.body1 = body1;
	            joint.body2 = body2;
	            joint.type = "stick";
	        ...
	        */
	        ...
	        key: 'addSpringJoint',
	        value: function addSpringJoint(body1, body2, distance, k, damping) {
	            var joint = {};
	            joint.body1 = body1;
	            joint.body2 = body2;
	            joint.type = "spring";
	        ...
	        */
	        ...
	        key: 'addStringJoint',
	        value: function addStringJoint(body1, body2, distance) {
	            var joint = {};
	            joint.body1 = body1;
	            joint.body2 = body2;
	            joint.type = "string";
	        ...
	        */
	        ...
	        key: 'addGravityJoint',
	        value: function addGravityJoint(body1, body2) {
	            var joint = {};
	            joint.body1 = body1;
	            joint.body2 = body2;
	            joint.type = "gravity";
	        ...
	        */
	        ...
	        key: 'addElectrostaticsJoint',
	        value: function addElectrostaticsJoint(body1, body2, charge1, charge2) {
	            var joint = {};
	            joint.body1 = body1;
	            joint.body2 = body2;
	        ...
	        */
	        ...
	        key: 'setGlobalGravity',
	        value: function setGlobalGravity(vector) {
	        ...
	        */
	        ...
	        key: 'setGlobalWind',
	        value: function setGlobalWind(vector) {
	...
	exports.Renderer3D = function (_Component) {
	    ...
	    */
	    function Renderer3D(params) {
	        ...
	        _this.cameras = [];
	        _this.fog = undefined;
	        _this.setCurrentScene("default");
	        _this.engine = new Mobilizing.Engine3D({ canvas: _this.canvas }); //3D engine creation - we pass the Canvas

	        //we must register the canvas when made internally by Mobilizing/Three
	        if (_this.canvas) {
	            _this.fullscreen = false;
	            debug.log("got canvas from runner to context", _this.canvas);
	        } else {
	            _this.canvas = _this.engine.canvas;
	            _this.fullscreen = true;
	            debug.log("got canvas from Engine", _this.canvas);
	        }
	        ...
	        window.addEventListener("scroll", function (event) {
	            return _this.updateCanvasPosition(event);
	        }, false);
	        window.addEventListener("resize", function (event) {
	            return _this.updateCanvasPosition(event);
	        }, false);

	        _this.canvasPosition = _this.getCanvasPosition();
	        return _this;
	    }
	    ...
	    createClass(Renderer3D, [{
	        ...
	        */
	        ...
	        key: 'setEnableShadowMap',
	        value: function setEnableShadowMap(state) {
	        ...
	        key: 'setCurrentScene',
	        value: function setCurrentScene(name) {
	        ...
	        key: 'addToCurrentScene',
	        value: function addToCurrentScene(object) {
	        ...
	        key: 'removeFromCurrentScene',
	        value: function removeFromCurrentScene(object) {
	        ...
	        key: 'removeCamera',
	        value: function removeCamera(cam) {
	        ...
	        key: 'setFog',
	        value: function setFog(type, color) {
	            if (!color) {
	                color = Color$1.black.clone();
	            }
	        ...
	        key: 'setFogNear',
	        value: function setFogNear(near) {
	        ...
	        key: 'setFogDensity',
	        value: function setFogDensity(val) {
	        ...
	        */
	        ...
	        value: function getCanvasPosition() {
	...
	exports.RendererAudio = function (_Component) {
	    ...
	    */
	    function RendererAudio(params) {
	        ...
	        //web Audio API
	        if (_this.params === undefined || _this.params.audioEnabled) {
	            if (window.AudioContext !== undefined) {
	                _this.audioContext = new window.AudioContext();
	            } else if (window.webkitAudioContext !== undefined) {
	                _this.audioContext = new window.webkitAudioContext();
	            }

	            //hack to reset the SR
	            if (_this.audioContext) {
	                if (_this.audioContext.sampleRate !== 44100) {
	                    var buffer = _this.audioContext.createBuffer(1, 1, 44100);
	                    var dummy = _this.audioContext.createBufferSource();
	                    dummy.buffer = buffer;
	                    dummy.connect(_this.audioContext.destination);
	                    dummy.start(0);
	                    dummy.disconnect();
	                ...
	                _this.audioOutputNode = _this.audioContext.createGain();
	                _this.audioOutputNode.connect(_this.audioContext.destination);
	            }
	        }

	        _this.listener = _this.audioContext.listener;

	        if (_this.listener.forwardX) {
	            _this.listener.forwardX.value = 0;
	            _this.listener.forwardY.value = 0;
	            _this.listener.forwardZ.value = -1;
	            _this.listener.upX.value = 0;
	            _this.listener.upY.value = 1;
	            _this.listener.upZ.value = 0;
	        } else {
	            _this.listener.setOrientation(0, 0, -1, 0, 1, 0);
	        }
	    ...
	    createClass(RendererAudio, [{
	        ...
	        key: 'setListenerTransform',
	        value: function setListenerTransform(transform) {
	    ...
	    */
	    ...
	    createClass(StyledTextElement, [{
	        ...
	        value: function update() {
	            ...
	            for (var i = 0; i < this.styledLetters.length; i++) {
	                var styledLetter = this.styledLetters[i];
	        ...
	        */
	        ...
	        value: function setText(val) {
	            ...
	            for (var i = 0; i < this.text.length; i++) {
	                ...
	                var styledLetter = new StyledLetter({ letter: String.fromCharCode(char),
	                    font: this.font,
	                    size: this.size,
	                    color: this.color
	                });
	...
	*/
	...
	var RichText = function (_Base) {
	    ...
	    */
	    function RichText(params) {
	        ...
	        _this._backgroundColor = getOrDefault(params, "backgroundColor", Color$1.white.clone());
	        _this._lineHeight = getOrDefault(params, "lineHeight", 1);

	        _this._margins = { left: 0, right: 0, top: 0, bottom: 0 };
	        var margins = getOrDefault(params, "margins", 10);
	        _this._margins.left = getOrDefault(params, "marginLeft", margins);
	        _this._margins.right = getOrDefault(params, "marginRight", margins);
	        _this._margins.top = getOrDefault(params, "marginTop", margins);
	        _this._margins.bottom = getOrDefault(params, "marginBottom", margins);

	        _this._textSize = getOrDefault(params, "textSize", 20);
	        _this._textColor = getOrDefault(params, "textColor", Color$1.black.clone());
	        _this._textAlign = getOrDefault(params, "textAlign", TEXT_ALIGN_LEFT);
	        _this._boundingBoxStrokeWidth = getOrDefault(params, "boundingBoxStrokeWidth", 1);
	        _this._drawBoundingBox = getOrDefault(params, "drawBoundingBox", false);
	        ...
	        _this._fontBoldURL = getOrDefault(params, "fontBoldURL", "fonts/Raleway-Bold.ttf");
	        _this._fontBoldItalicURL = getOrDefault(params, "fontBoldItalicURL", "fonts/Raleway-Bold-Italic.ttf");
	        ...
	        _this._canvas.events = new EventEmitter({ scope: _this._canvas });

	        /*document.body.appendChild(this._canvas);
	        this._canvas.style.position = "absolute";*/

	        _this._text = getOrDefault(params, "text", undefined);

	        if (_this._text) {
	            _this._DOMText = document.createElement("div");
	            _this._DOMText.innerHTML = _this._text;
	            _this.styledText = _this.parseDOMTree(_this._DOMText);
	        } else {
	    ...
	    */
	    ...
	    createClass(RichText, [{
	        ...
	        value: function setup() {
	            ...
	            this._defaultBoldFont = new Font$1({ fontFile: this._defaultBoldFontFile });
	            this._defaultBoldItalicFont = new Font$1({ fontFile: this._defaultBoldItalicFontFile });
	        ...
	        */
	        ...
	        key: 'parseDOMTree',
	        value: function parseDOMTree(baseNode) {
	            var styledText = [];
	        ...
	        */
	        ...
	        key: 'processDOMTree',
	        value: function processDOMTree(baseNode, destArray) {
	            var i = 0;
	            var node = void 0;
	                ...
	                if (children >= 1) {
	                    ...
	                    for (var w = 0; w < words.length; w++) {
	                        ...
	                        if (node.parentNode.attributes) {
	                            for (var a = 0; a < node.parentNode.attributes.length; a++) {
	        ...
	        */
	        ...
	        value: function render() {
	            //background color
	            if (this._backgroundColor !== Color$1.transparent.makeRGBAStringWithAlpha(0)) {
	            ...
	            for (var i = 0; i < this.styledText.length; i++) {
	                var el = this.styledText[i];

	                //select the font to use
	                var currentFont = this._defaultFont;
	                ...
	                if (el.tags.indexOf("B") >= 0 && el.tags.indexOf("I") >= 0 || el.tags.indexOf("STRONG") >= 0 && el.tags.indexOf("EM") >= 0) {
	                    currentFont = this._defaultBoldItalicFont;
	                }

	                var size = this._textSize;
	                ...
	                var tempWidth = letterXOffset + currentFont.getTextSize(el.text, size).width;
	                ...
	                if (el.attributes) {
	                    for (var j = 0; j < el.attributes.length; j++) {
	                        if (el.attributes[j].name === "color") {
	                            color = new Color$1(el.attributes[j].value);
	                        }
	                ...
	                var fontTextSize = currentFont.getTextSize(el.text, size);
	                ...
	                if (this._lines[lineCount]) {
	                    var lineObj = this._lines[lineCount];
	                    lineObj.styledTextElements.push(el);
	                    lineObj.width += el.width;
	                } else {
	                    var _lineObj = new TextLine();
	                    _lineObj.styledTextElements.push(el);
	                    _lineObj.width += el.width;

	                    this._lines.push(_lineObj);
	                }
	            ...
	            for (var _i = 0; _i < this._lines.length; _i++) {
	                var xDiff = void 0;
	                var line = this._lines[_i];
	                ...
	                if (xDiff !== undefined) {
	                    for (var _j = 0; _j < line.styledTextElements.length; _j++) {
	                        var _el = line.styledTextElements[_j];
	                        _el.setX(_el.x + xDiff);
	                        _el.update(); //refresh
	                    }
	                }
	            }
	            ...
	            //draw loop
	            for (var _i2 = 0; _i2 < this.styledText.length; _i2++) {
	                var _el2 = this.styledText[_i2];
	                _el2.path.draw(this._canvasContext);

	                if (this._drawBoundingBox) {
	                    var boundingBox = _el2.path.getBoundingBox();
	...
	var CanvasTexture = function () {
	    ...
	    */
	    function CanvasTexture(params) {
	        ...
	        this._canvas = getOrExec(params, "canvas", function () {
	    ...
	    */
	    ...
	    createClass(CanvasTexture, [{
	        ...
	        */
	        ...
	        key: 'fillWithColor',
	        value: function fillWithColor(color) {
	        ...
	        */
	        ...
	        key: 'setStrokeColor',
	        value: function setStrokeColor(c) {
	            this._strokeColor = c;
	        }
	        ...
	        */
	        ...
	        key: 'drawStyledText',
	        value: function drawStyledText(text) {
	        ...
	        */
	        ...
	        value: function drawImage(image, x, y, width, height) {
	            this._canvasContext.drawImage(image, x ? x : 0, y ? y : 0, width ? width : this._width, height ? height : this._height);
	        ...
	        */
	        ...
	        key: 'toRGBAColorString',
	        value: function toRGBAColorString(color, alpha) {
	        ...
	        */
	        ...
	        key: 'CreateRect',
	        value: function CreateRect(params) {
	            var width = getOrDefault(params, "width", 100);
	            var height = getOrDefault(params, "height", 100);
	    ...
	    */
	    ...
	    createClass(DOMNodeTexture, [{
	        ...
	        */
	        ...
	        key: "addCSSToNode",
	        value: function addCSSToNode(el, cssName) {
	    ...
	    createClass(ImageSequenceTexture, [{
	        ...
	        value: function load(urlbase, min, max) {
	            for (var i = min; i <= max; ++i) {
	                var t = new Texture$1({ context: this.context });
	        ...
	        */
	        ...
	        key: 'setEnterFrame',
	        value: function setEnterFrame(frame) {
	        ...
	        */
	        ...
	        key: 'setOutFrame',
	        value: function setOutFrame(frame) {
	...
	var Timer = function (_Component) {
	    ...
	    */
	    function Timer(params) {
	        ...
	        _this.interval = getOrDefault(params, "interval", 100); //milliseconds
	...
	var NTP = function (_Component) {
	    ...
	    */
	    function NTP(params) {
	        ...
	        _this._timeScale = getOrDefault(params, "scale", 1);
	        _this._smoothingFactor = getOrDefault(params, "smoothingFactor", 0.9);
	        _this._NTPEnabled = getOrDefault(params, "NtpEnabled", false);

	        _this._currentTime = 0;
	        _this._deltaTime = 0;
	        _this._timeOffsetSmooth = 0;
	    ...
	    */
	    ...
	    createClass(Clickable, [{
	        ...
	        value: function setup() {
	            ...
	            this.pointer.events.on("on", function (event) {
	            ...
	            this.pointer.events.on("moved", function (event) {
	                ...
	                if (pick) {
	                    ...
	                    if (_this2.picked) //avoid useless recall
	                        {
	                            _this2.onLeave();
	...
	var Button = function (_Component) {
	    ...
	    function Button(params) {
	        ...
	        _this.cutOff = getOrDefault(params, "cutOff", _this.height / 3);
	        _this.strokeWidth = getOrDefault(params, "strokeWidth", 0.1);

	        _this.strokeColor = getOrDefault(params, "strokeColor", Color$1.mobilizing.clone());
	        _this.fillColor = getOrDefault(params, "fillColor", Color$1.white.clone());
	        ...
	        _this.text = getOrDefault(params, "text", undefined);
	        _this.textSize = getOrDefault(params, "textSize", 40);
	        //main node
	        _this.root = new Mesh$1({ primitive: "node" });

	        _this.transform = _this.root.transform;

	        //to get the state
	        _this.state = BT_STATE_RELEASED;
	        ...
	        if (_this.text) {
	            ...
	            var richText = new Mobilizing.RichText({ width: canvasWidth,
	                height: canvasHeight,
	                text: _this.text,
	                marginTop: canvasHeight / 2 - _this.textSize / 2,
	                backgroundColor: Color$1.transparent.makeRGBAStringWithAlpha(0),
	                textColor: Color$1.mobilizing.clone(),
	                textAlign: "center",
	                textSize: _this.textSize,
	                fontURL: _this._fontURL,
	                fontItalicURL: _this._fontItalicURL,
	                fontBoldURL: _this._fontBoldURL,
	                fontBoldItalicURL: _this._fontBoldItalicURL });
	            ...
	            _this.textTexture = new Texture$1({ canvas: richText.getCanvas() });
	            _this.pressTextTexture = new Texture$1({ canvas: pressRichText.getCanvas() });
	        ...
	        if (!_this.mesh) {
	            _this.generateDefaultMesh();
	        }

	        _this.root.transform.addChild(_this.mesh.transform);
	        return _this;
	    }
	    ...
	    createClass(Button, [{
	        ...
	        value: function setup() {
	            ...
	            this.clickable = new Clickable({ camera: this.camera,
	                ...
	                onPress: function onPress() {
	                    if (_this2._active) {
	                        _this2.mesh.material.setColor(_this2.pressFillColor);
	                        if (_this2.pressTextTexture) {
	                            _this2.texturedMesh.material.setTexture(_this2.pressTextTexture);
	                        }
	                        _this2.onPress();
	                        _this2.state = BT_STATE_PRESSED;
	                    }
	                },

	                onRelease: function onRelease() {
	                    if (_this2._active) {
	                        _this2.mesh.material.setColor(_this2.hoverFillColor);
	                        if (_this2.textTexture) {
	                            _this2.texturedMesh.material.setTexture(_this2.textTexture);
	                        }
	                        _this2.onRelease();
	                        _this2.state = BT_STATE_RELEASED;
	                    }
	                },
	                ...
	                onLeave: function onLeave() {
	                    if (_this2._active) {
	                        _this2.mesh.material.setColor(_this2.fillColor);
	                        if (_this2.textTexture) {
	                            _this2.texturedMesh.material.setTexture(_this2.textTexture);
	                        }
	                        _this2.onLeave();
	        ...
	        */
	        ...
	        key: 'generateDefaultMesh',
	        value: function generateDefaultMesh() {
	            //vertices
	            var w = this.width / 2;
	            var h = this.height / 2;
	            //this.cutOff = h/2;
	            ...
	            if (this.radius) {
	                ...
	                var parts = this.sideCount;
	                var radius = this.radius;

	                for (var i = 0; i < parts; i++) {
	                    //arc(a, b, c, d, start, stop, mode)
	                    this.vertex.push(new Vector2$1(Math.cos(_Math.degToRad(360 / parts / 2) + Math.PI * 2 / parts * i) * radius, Math.sin(_Math.degToRad(360 / parts / 2) + Math.PI * 2 / parts * i) * radius));
	                }
	            } else {
	                this.vertex.push(new Vector2$1(-w + this.cutOff, h));
	                this.vertex.push(new Vector2$1(w - this.cutOff, h));
	                this.vertex.push(new Vector2$1(w, h - this.cutOff));
	                this.vertex.push(new Vector2$1(w, -h + this.cutOff));
	                this.vertex.push(new Vector2$1(w - this.cutOff, -h));
	                this.vertex.push(new Vector2$1(-w + this.cutOff, -h));
	                this.vertex.push(new Vector2$1(-w, -h + this.cutOff));
	            ...
	            this.mesh = new Mesh$1({ primitive: "custom" });
	            this.mesh.generateFillMesh(this.vertex);
	            this.mesh.material.setTransparent(true);

	            if (this.text) {
	                this.texturedMesh = new Mesh$1({ primitive: "custom" });
	            ...
	            this.strokeMesh = Mesh$1.generateStrokeMesh(this.mesh, this.strokeWidth);
	        ...
	        */
	        ...
	        key: 'regenerateStrokeGeometry',
	        value: function regenerateStrokeGeometry(mesh) {
	...
	var ButtonGroup = function (_Component) {
	    ...
	    function ButtonGroup(params) {
	        ...
	        _this.buttons = getOrDefault(params, "buttons", []);
	        _this.orderedIndices = [];
	        ...
	        if (_this.buttons.length > 0) {
	            ...
	            for (var i = 0; i < _this.buttons.length; i++) {
	                _this.root.transform.addChild(_this.buttons[i].transform);
	            }

	            _this.organize(mode, columns, offsetType);
	        }
	        return _this;
	    }
	    ...
	    */
	    ...
	    createClass(ButtonGroup, [{
	        ...
	        */
	        ...
	        key: 'organizeGrid',
	        value: function organizeGrid(columns) {
	            var tempIndices = [];
	        ...
	        */
	        ...
	        key: 'positionGrid',
	        value: function positionGrid(indices) {
	            var index = 0;
	            ...
	            for (var i = 0; i < indices.length; i++) //line nb
	            {
	                ...
	                for (var j = 0; j < line.length; j++) // column nb
	                {
	                    var bt = this.buttons[line[j].index];
	        ...
	        value: function renderGrid() {
	            for (var i = 0; i < this.orderedIndices.length; i++) {
	                var order = this.orderedIndices[i];
	                ...
	                if (order.isTop && order.isLeft && !order.isBottom && order.isRight) {
	                    ...
	                    var nextOrder = this.orderedIndices[i + 1];
	        ...
	        value: function positionHoneyComb(indices, offsetType) {
	            ...
	            for (var i = 0; i < indices.length; i++) //line nb
	            {
	                ...
	                for (var j = 0; j < line.length; j++) // column nb
	                {
	                    ...
	                    var interval = bt.mesh.getBoundingBox().getSize().y * 3 / 4;
	        ...
	        key: 'renderHoneyComb',
	        value: function renderHoneyComb() {
	            for (var i = 0; i < this.orderedIndices.length; i++) {
	                var order = this.orderedIndices[i];
	                var bt = this.buttons[i];
	        ...
	        value: function computeSize() {
	            var bbox = this.buttons[0].mesh.getBoundingBox();
	...
	var TextField = function (_Base) {
	    ...
	    */
	    function TextField(params) {
	        ...
	        _this._styledLetters = [];
	        _this._maxCharCount = getOrDefault(params, "maxCharCount", 1000);
	        _this._maxLineCount = getOrDefault(params, "maxLineCount", 1);
	        _this._size = getOrDefault(params, "size", 20);
	        _this._color = getOrDefault(params, "color", Color$1.gray);
	        _this._backgroundColor = getOrDefault(params, "backgroundColor", Color$1.white);
	        _this._lineHeight = getOrDefault(params, "lineHeight", 1);

	        _this._margins = getOrDefault(params, "margins", 10);

	        _this._width = getOrDefault(params, "width", 300);
	        ...
	        _this._font = getOrDefault(params, "font", undefined);
	        //to easily switch fonts in rendering process
	        _this._currentFont = _this._font;

	        _this._cursorColor = getOrDefault(params, "cursorColor", _this._color);
	        _this._cursorWidth = getOrDefault(params, "cursorWidth", 2);
	        _this._blinkTime = getOrDefault(params, "blinkTime", 300);
	        _this._blinkState = false;
	        setInterval(_this.onBlink.bind(_this), _this._blinkTime);

	        _this._cursorIndex = -1; //to get the position of the cursor from the letters!
	        _this._cursorX = 0;
	        _this._cursorY = 0;
	    ...
	    createClass(TextField, [{
	        ...
	        */
	        ...
	        value: function addLetter(val) {
	            ...
	            var styledLetter = new StyledLetter({ letter: letter,
	        ...
	        */
	        ...
	        key: 'moveCursorTo',
	        value: function moveCursorTo(index) {
	        ...
	        */
	        ...
	        key: 'pickLetter',
	        value: function pickLetter(x, y) {
	            for (var i = 0; i < this._styledLetters.length; i++) {
	                var el = this._styledLetters[i];
	                var bbox = el.path.getBoundingBox();
	                var rect = [{ x: bbox.x1, y: bbox.y1 }, { x: bbox.x2, y: bbox.y1 }, { x: bbox.x2, y: bbox.y2 }, { x: bbox.x1, y: bbox.y2 }];
	        ...
	        value: function render() {
	            ...
	            for (var i = 0; i < this._styledLetters.length; i++) {
	                if (i < this._maxCharCount) {
	                    ...
	                    //test for new line from canvas width limit and reset offsets and add a new line to lineCount
	                    var tempWidth = letterXOffset + el.width;
	            ...
	            //draw the cursor
	            if (this._blinkState) {
	                var _el = this._styledLetters[this._cursorIndex];

	                if (_el) {
	                    var boundingBox = _el.path.getBoundingBox();
	                    ...
	                    if (_el.height < 1) //manage blank space
	                        {
	                            this._canvasContext.moveTo(_el.x + _el.width, _el.y);
	                            this._canvasContext.lineTo(_el.x + _el.width, _el.y);
	                            this._canvasContext.lineTo(_el.x + _el.width, _el.y - this._size);
	    ...
	    */
	    ...
	    createClass(EasyContext, [{
	        ...
	        */
	        ...
	        key: 'getMainRenderer',
	        value: function getMainRenderer() {
	            return this.renderer;
	        }
	    }, {
	        key: 'getRenderingSurface',
	        value: function getRenderingSurface() {
	            return this.canvas;
	        }
	    }, {
	        key: 'getTouchSurface',
	        value: function getTouchSurface() {
	            return this.canvas;
	        }
	        ...
	        */
	        ...
	        value: function createLight() {
	            var light = new (Function.prototype.bind.apply(Mobilizing.Light, [null].concat(Array.prototype.slice.call(arguments))))();
	        ...
	        key: 'createLabel',
	        value: function createLabel(params) {
	            params.context = this;
	        ...
	        value: function createCamera() {
	            var cam = new (Function.prototype.bind.apply(Mobilizing.Camera, [null].concat(Array.prototype.slice.call(arguments))))();
	            this.addCamera(cam);
	        ...
	        key: 'createCameraX',
	        value: function createCameraX(params) {
	            //DEPRECATED
	        ...
	        key: 'createVideoQuad',
	        value: function createVideoQuad(url) {
	        ...
	        key: 'loadObj3dModel',
	        value: function loadObj3dModel(model_url, texture_url) {
	        ...
	        key: 'onObjLoaded',
	        value: function onObjLoaded(model) {
	        ...
	        key: 'createAudioSource',
	        value: function createAudioSource(url) {
	        ...
	        key: 'createTextureFromCubeCamera',
	        ...
	        key: 'loadTexture',
	        value: function loadTexture(url, asynchro) {
	            var texture = new Mobilizing.Texture({ context: this });
	        ...
	        value: function createTextButton(text, width, height, font, fontSize, position, scale) {
	...
	exports.StyledTextElement = StyledTextElement;
	exports.TextLine = TextLine;
	exports.RichText = RichText;
	exports.CanvasTexture = CanvasTexture;
	exports.DOMNodeTexture = DOMNodeTexture;
	exports.ImageSequenceTexture = ImageSequenceTexture;
	...
	exports.EasyContext = EasyContext;

	Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=Mobilizing.js.map
